...
// Silenciar el echo de conexión para no romper el HTML
ob_clean();
...
<div class="modal-overlay" id="deleteModal">
    <div class="modal">
        ...
        <div class="modal-actions">
            ...
            <a href="#" class="modal-btn confirm" id="confirmBtn">Sí, eliminar</a>
        </div>
    </div>
</div>
...
function confirmDelete(id, nombre) {
    ...
    document.getElementById('confirmBtn').href = `eliminar.php?id=${id}`;
...
function filterTable() {
    ...
    let visible  = 0;
    rows.forEach(row => {
        const ok = (row.dataset.nombre.includes(search) || row.dataset.correo.includes(search))
